...
const string strMessageMagic = "Shopxcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 258000 * COIN; // SHOPX Swap Block
    }
		else if(pindexBest->nHeight < 21000)
    {
		nSubsidy = 5 * COIN; //PoW Phase lasts 14.5 days
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Shopxcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Shopxcoin X13 2014/31/07";
        CTransaction txNew;
        txNew.nTime = 1406856700;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x399854762373aa8359d3ebe455b4982efbb9eaa4f4a00dc7edb0f23f7830d31a"));
        block.print();
