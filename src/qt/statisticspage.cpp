...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "X13 PoW (PoS Starts Block 21000)";
    }
    ...
    {
		subsidy = "258000 SHOPX";
    }
	else if(pindexBest->nHeight < 21000)
    {
		subsidy = "5 SHOPX";
    }
	else if(pindexBest->nHeight < 9999999999)
	{
		subsidy = "PoS Phase";
	}
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " SHOPX" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " SHOPX" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " SHOPX");
    }
